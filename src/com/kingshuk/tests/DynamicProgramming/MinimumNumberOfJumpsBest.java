...
public class MinimumNumberOfJumpsBest {
     ...
     * We continue this process till the value of the farthest reachable index is greater than n - 1.
     *
     ...
     * to currMaxReach.
     * During the update of currMaxReach, we also need to check whether currMaxReach is greater than n - 1. If it is true,
